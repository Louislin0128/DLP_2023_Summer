...
class ActorNet(nn.Module):
    def __init__(self, state_dim=8, action_dim=2, hidden_dim=(400, 300)):
        ...
        """ TODO """
        h1, h2 = hidden_dim
        self.fc1 = nn.Sequential(nn.Linear(state_dim, h1),  nn.ReLU(inplace = True))
        self.fc2 = nn.Sequential(nn.Linear(h1, h2),         nn.ReLU(inplace = True))
        self.fc3 = nn.Sequential(nn.Linear(h2, action_dim), nn.Tanh())
